...
export const MonolithExternalLinkSchema =
	new EntitySchema<MonolithExternalLink>({
...
export const MonolithNoteExternalLinkSchema = new EntitySchema<
	MonolithNoteExternalLink,
	MonolithExternalLink
>({
	class: MonolithNoteExternalLink,
	extends: MonolithExternalLinkSchema,
	// schema: 'monolith',
	tableName: 'external_links',
